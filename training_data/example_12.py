"""
	Command: Drive forward at 50% speed for 5 seconds. Right side is inverted
...
class DriveForward5Seconds:
    ...
    def run(self):
        ...
        GPIO.output(self.MOTOR_RIGHT_PWM_B, self.MAX_SPEED*0.5)
        GPIO.output(self.MOTOR_LEFT_PWM_A, self.MAX_SPEED*0.5)
